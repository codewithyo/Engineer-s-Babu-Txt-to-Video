...
async def start(client: Client, msg: Message):
    ...
    await start_message.edit_text(
        Data.START.format(msg.from_user.mention) +
        "Checking status Ok... Command Nhi Bataunga **Bot Made BY 𝙷𝚁**🔍\n\n"
        "Progress:[🟩🟩🟩🟩🟩🟩🟩🟩🟩] 100%\n\n"
    )
...
@bot.on_message(filters.command(["codewithyo","uploader"]) )
async def txt_handler(bot: Client, m: Message):
    ...
    credit = f"Yatin Goyal"
    token = f"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..6NWPyT3u-LaC-OvXF9a41aZPz9ymBkxCgBS7_ITMbxQ"
    try:    
        with open(x, "r") as f:
            content = f.read()
    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            if "visionias" in url:
             ...
             vid_id =  url.split("/")[-2]
             url =  f"https://asmultiversepw.onrender.com/{vid_id}/master.m3u8?token={raw_text4}"
...
async def txt_handler(bot: Client, m: Message):
    ...
    input: Message = await bot.listen(edita
